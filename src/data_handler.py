    ...
    def __init__(self, name, batch_size):
        if name == "cifar":
            ...
            train_data = TinyImageNetDataset(
                './data/tiny-imagenet-200/train', train=True)
        ...
        if name == "cifar":
            ...
            trainset = TinyImageNetDataset("./data/tiny-imagenet-200/train",
                                           train=True,
                                           transform=transform_train)
            testset = TinyImageNetDataset("./data/tiny-imagenet-200/test",
                                          train=False,
                                          transform=transform_test)
